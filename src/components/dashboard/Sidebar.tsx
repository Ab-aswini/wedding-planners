...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/invites', label: 'Invites', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  ...
  return (
    <aside className="w-64 bg-sidebar-bg text-sidebar-text flex flex-col min-h-screen">
      ...
      <div className="px-6 py-5 border-b border-gray-800">
        <Link href="/dashboard" className="text-xl font-bold font-[family-name:var(--font-heading)] text-accent">
          InviteForge
        </Link>
        {org && (
